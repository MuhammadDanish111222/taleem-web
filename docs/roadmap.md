...
- [x] Run 2 exit gate: the student Ask UI, local-only administration, real configuration, approved/grounded/general staging, deployment, push, CI, and public WhatsApp support setting are verified.
